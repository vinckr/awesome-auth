...
- [Ory Kratos](https://github.com/ory/kratos) - API-first Identity and User Management system built for cloud a
...
- [Ladon](https://github.com//ladon) - SDK for access control policies: authorization for the microservice and IoT age.
